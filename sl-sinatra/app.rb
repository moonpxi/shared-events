...
get '/week' do
  ...
  @events_per_day = Event.within_period_for(@user, @period).where(:start_at => {'$gte' => week_start.to_time, '$lte' => week_end.to_time + 169999}).group_by { |event| event.start_at.to_date }
